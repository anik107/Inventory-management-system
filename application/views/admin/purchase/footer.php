 <!-- footer content -->
        <footer>
          <div class="pull-right">
            <a href="https://colorlib.com">Made By Likhon</a>
          </div>
  ...
  $(document).ready(function(){
    ...
    $('#supplier').on('change', function(){
      ...
      if(supplier_id==''){
        ...
        $.ajax({
          url: "<?php echo base_url() ?>purchase/get_brands",
          type: "POST",
  ...
  $(document).ready(function(){
    ...
    $('#supplier').on('change', function(){
      ...
      if(supplier_id==''){
        ...
        $.ajax({
          url: "<?php echo base_url() ?>purchase/get_product",
          type: "POST",
          data: {'supplier_id' : supplier_id},
          dataType: 'json',
          success: function(data){
  ...
  $(document).ready(function(){
    ...
    $('#brand').on('change', function(){
      ...
      if(brand_id==''){
        ...
        $.ajax({
          url: "<?php echo base_url() ?>purchase/get_categories",
          type: "POST",
