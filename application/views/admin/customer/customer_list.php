                            ...
                            <thead>
                             ...
                             <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  <?= anchor("customer/edit_customer/{$customer->customer_id}", '<i class="fa fa-edit"></i>', ['class'=>'btn btn-default']); ?>
                                <!-- </td> -->
                               
                                  <a class="btn btn-default" onclick="javascript:deleteConfirm('<?php echo base_url().'customer/close_customer/'.$customer->customer_id ?>');" deleteConfirm href="#"><i class="fa fa-trash"></i></a>
                                </td>
