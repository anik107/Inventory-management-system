                            ...
                            <thead>
                             ...
                             <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  <?= anchor("supplier/edit_supplier/{$record->supplier_id}", '<i class="fa fa-edit"></i>', ['class'=>'btn btn-default']); ?>
                                <!-- </td> -->
                               
                                  <a class="btn btn-default" onclick="javascript:deleteConfirm('<?php echo base_url().'supplier/close_supplier/'.$record->supplier_id ?>');" deleteConfirm href="#"><i class="fa fa-trash"></i></a>
                                </td>
