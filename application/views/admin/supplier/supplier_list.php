  ...
  <?php echo form_open('supplier/search_supplier'); ?>
  ...
  <?php echo form_error('query', "<div class='text-danger'>", '</div>'); ?> 
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <button type="button" class="btn btn-success pull-right" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="glyphicon glyphicon-plus-sign"></i> Add Supplier</button>
                            ...
                            <thead>
                             ...
                             <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  <?= anchor("supplier/edit_supplier/{$supplier->supplier_id}", '<i class="fa fa-edit"></i>', ['class'=>'btn btn-default']); ?>
                                <!-- </td> -->
                               
                                  <a class="btn btn-default" onclick="javascript:deleteConfirm('<?php echo base_url().'supplier/close_supplier/'.$supplier->supplier_id ?>');" deleteConfirm href="#"><i class="fa fa-trash"></i></a>

                                  <?= anchor("supplier/add_product/{$supplier->supplier_id}", '<i class="fa fa-cubes"></i>', ['class'=>'btn btn-default']); ?>

                                  <?= anchor("supplier/product_list/{$supplier->supplier_id}", '<i class="fa fa-eye"></i>', ['class'=>'btn btn-default']); ?>
