                            ...
                            <thead>
                             ...
                             <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  <?= anchor("unit/edit_unit/{$record->unit_id}", '<i class="fa fa-edit"></i>', ['class'=>'btn btn-default']); ?>
                                <!-- </td> -->
                               
                                  <a class="btn btn-default" onclick="javascript:deleteConfirm('<?php echo base_url().'unit/close_unit/'.$record->unit_id ?>');" deleteConfirm href="#"><i class="fa fa-trash"></i></a>
